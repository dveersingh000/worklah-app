...
import 'package:work_lah/services/api_service.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void generateOtp() async {
    ...
    if (mobileNumber.isEmpty) {
      toast('Please enter your mobile number', backgroundColor: Colors.red);
      return;
    }
    ...
    try {
      var response = await apiService.post('api/auth/generate-otp', {
        'countryCode': selectedCode,
        'mobileNumber': mobileNumber,
      });

      if (response['success']) {
        toast('OTP sent successfully', backgroundColor: AppColors.themeColor);
      } else {
        toast(response['message'] ?? 'Failed to send OTP',
  ...
  // Directly navigate to Home Screen (BottomBarScreen)
